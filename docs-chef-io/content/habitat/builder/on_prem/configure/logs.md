...
For more details about logging in Chef Habitat, see the [Supervisor log configuration reference](/habitat/2.1/sup/sup_log_configuration/) and the [Supervisor log key documentation](/habitat/2.1/reference/sup_log_keys/).
