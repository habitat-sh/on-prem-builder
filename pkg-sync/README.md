...
Note that the public builder tokens used in the examples below must be associated with a valid license key. See [these instructions](../docs-chef-io/content/habitat/builder/on_prem/packages/bootstrap_core_packages.md#add-a-license-key) on entering a license key.
...
Note that the public builder tokens used in the examples above must be associated with a valid license key. See [these instructions](../docs-chef-io/content/habitat/builder/on_prem/packages/bootstrap_core_packages.md#add-a-license-key) on entering a license key.